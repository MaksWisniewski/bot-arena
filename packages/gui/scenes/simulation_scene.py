...
from packages.gui.gui_objects import Scene, Button, Window, List, NumberField, Text, ProgressBar, InputField
...
class SimulationSceneManager(AbstractSceneManager):
    def load_scene(self, scene_functions):
        return Scene([
            ...
            Window([
                ...
                Text((0.05, CONTROLS_GAP3 * 2 + 0.2), (0.5, 0.2), text="Map size Y:",
                ...
                (SIDEBAR_SIZE + (PROPORTION1 - SIDEBAR_SIZE) / 2, PROPORTION3),
                ((PROPORTION1 - SIDEBAR_SIZE) / 2, 1 - PROPORTION3),
                name='Add random map',
                icon='controls'),
            Window([
                ...
                Text((0.05, CONTROLS_GAP1 * 4 + 0.3), (0.5, 0.1), text="number of games:",
                     background_color=GUI_COLORS['blocked']),
                NumberField(
                ...
                Text((0.05, CONTROLS_GAP1 * 5 + 0.4), (0.5, 0.1), text="max ready timeout [s]:",
                     background_color=GUI_COLORS['blocked']),
                NumberField(
                ...
                Text((0.05, CONTROLS_GAP1 * 6 + 0.5), (0.5, 0.1), text="max move timeout [s]:",
                     background_color=GUI_COLORS['blocked']),
                NumberField(
                ...
                Text((0.05, CONTROLS_GAP1 * 7 + 0.6), (0.5, 0.1), text="max game timeout [s]:",
                     background_color=GUI_COLORS['blocked']),
                NumberField(
            ...
            Window([
                ...
                Text((0.05, CONTROLS_GAP2 * 2 + 0.15 / PROPORTION2), (0.35, 0.15 / PROPORTION2), text="bot1 won games:",
                     background_color=GUI_COLORS['blocked']),
                ProgressBar(
                    (0.42, CONTROLS_GAP2 * 2 + 0.15 / PROPORTION2), (0.36, 0.15 / PROPORTION2),
                    id='bot1_won_progress_bar',
                ),
                Text((0.8, CONTROLS_GAP2 * 2 + 0.15 / PROPORTION2), (0.15, 0.15 / PROPORTION2), text="0",
                     background_color=GUI_COLORS['blocked'], id='bot1_wins'),
                Text((0.05, CONTROLS_GAP2 * 3 + 0.3 / PROPORTION2), (0.35, 0.15 / PROPORTION2), text="bot2 won games:",
                     background_color=GUI_COLORS['blocked']),
                ProgressBar(
                    (0.42, CONTROLS_GAP2 * 3 + 0.3 / PROPORTION2), (0.36, 0.15 / PROPORTION2),
                    id='bot2_won_progress_bar',
                ),
                Text((0.8, CONTROLS_GAP2 * 3 + 0.3 / PROPORTION2), (0.15, 0.15 / PROPORTION2), text="0",
                     background_color=GUI_COLORS['blocked'], id='bot2_wins'),
            ],
    ...
    def generate_map(self):
        ...
        map_name = self.scene.get_info('map_name_input', 'text')
        Game().generate_random_map(path.join(MAPS_DIRECTORY, f'{map_name}.json'), size_x, size_y)
